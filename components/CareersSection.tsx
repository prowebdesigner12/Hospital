    ...
    <section id="careers" className="bg-blue-900">
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-blue-200 max-w-2xl mx-auto mb-8">
          Be a part of a team that is dedicated to making a difference in the lives of others. Explore our open positions and start your journey with Max Healthcare.
        </p>
        <a
          href="#"
