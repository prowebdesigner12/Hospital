...
import { TABBED_SPECIALTIES, TABBED_PROCEDURES } from '../constants';
...
const SpecialtiesAndProcedures: React.FC = () => {
    ...
    const renderContent = () => {
        const items = activeTab === 'specialities' ? TABBED_SPECIALTIES : TABBED_PROCEDURES;
        return (
            <div>
                ...
                <div className="flex flex-col lg:flex-row items-center lg:gap-12">
                    ...
                    <div className="lg:w-1/2 w-full mb-12 lg:mb-0">
                        ...
                        <div className="flex items-center space-x-4 mb-6 border-b">
                           <TabButton title="Specialities" isActive={activeTab === 'specialities'} onClick={() => setActiveTab('specialities')} />
                           <TabButton title="Procedures" isActive={activeTab === 'procedures'} onClick={() => setActiveTab('procedures')} />
                        </div>
                        ...
                        <div className="relative bg-blue-900 rounded-2xl p-8 lg:p-12 overflow-hidden text-white group">
                            ...
                            <div className="relative z-20">
                                ...
                                <p className="text-blue-100 mb-8 max-w-sm">
                                    Max Healthcare is home to some of the most eminent doctors in the world. Let us help you find the right one.
                                </p>
                                <a 
                                    href="#" 
