...
const Hero: React.FC = () => {
    const [typedText, setTypedText] = useState('Top Priority');
    const words = ['Top Priority', 'First Concern', 'Main Focus'];
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl">
                    <h1 className="text-4xl sm:text-6xl font-bold mb-6 leading-tight" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.3)'}}>
                        Your Health Is Our <span className="text-[#9ac8d4] min-h-[60px] sm:min-h-[72px] inline-block">{typedText}</span>
                    </h1>
                    <p className="text-xl sm:text-2xl mb-8 max-w-2xl" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.3)'}}>
                        Delivering world-class healthcare with compassion and cutting-edge technology for over 25 years.
                    </p>
